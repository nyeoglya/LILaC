...
def mmqa_eval_load(dev_path: str, text_path: str, img_path: str, table_path: str) -> tp.List[QueryAnswer]:
    def load_jsonl(path):
        data = []
